...
CONFIG = {
    ...
    # To use ozturkoktay model: Set path to trained weights file
    # Example: 'dl_model_path': '/path/to/server/models/ozturkoktay_model.pth'
    # Run: python3 server/scripts/setup_ozturkoktay_model.py to get started
