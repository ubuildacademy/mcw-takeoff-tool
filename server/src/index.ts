...
import { conditionFolderRoutes } from './routes/conditionFolders';
...
import hyperlinkRoutes from './routes/hyperlinks';
import conditionTemplateRoutes from './routes/conditionTemplates';
...
app.use('/api/condition-folders', conditionFolderRoutes);
...
app.use('/api/condition-templates', conditionTemplateRoutes);
